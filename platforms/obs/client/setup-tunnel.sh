...
#   4457  overlay listener      (features/overlay - stat bars and chat, one listener for both)
...
#   BUGBOT_TUNNEL_PORTS="4456 4457 4459" ./setup-tunnel.sh user@server
...
PORTS="${BUGBOT_TUNNEL_PORTS:-4456 4457 4459}"
