...
Counterpart to features/overlay/config.py and features/chat_panel/config.py, and separate
from companion.json for the same reason: the JSON file is what you look into when adapting
...
# the overlay (4457) and the chat panel (4458).
COMPANION_PORT = int(os.environ.get("COMPANION_PORT") or 4459)

# Bind address. Same consideration as OBS_BRIDGE_BIND/OVERLAY_BIND/CHAT_PANEL_BIND: 0.0.0.0
